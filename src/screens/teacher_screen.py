...
def teacher_screen_login():
    ...
    st.space()
    st.space()
    teacher_username = st.text_input("Enter username", placeholder='arun')
...
def register_teacher(teacher_username,teacher_name,teacher_pass,teacher_pass_confirm):
    if not teacher_name or not teacher_name or not teacher_pass:
...
def teacher_screen_register():
    ...
    st.space()
    teacher_username = st.text_input("Enter username", placeholder='Arun')
    teacher_name = st.text_input("Enter name", placeholder='Arun')
    teacher_pass = st.text_input("Enter password", placeholder='Enter password', type='password')
